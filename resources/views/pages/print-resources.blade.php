...
<div class="p-6 space-y-8">
    ...
    @if($level == 3)
        ...
        <form method="GET" class="space-y-4 bg-white p-4 rounded-xl shadow mb-4">
            <div class="flex gap-2">
                <div class="relative flex-1">
                    <input type="text"
                        name="school_search"
                        placeholder="Search School Library... Title, Author, ISBN, Publisher, Grade, Subject..."
...
<script>
    ...
    // Reset for School Library Resources filters (Level 3)
    document.getElementById('resetSchoolFilters')?.addEventListener('click', function() {
        // Reset form fields
        document.querySelector('input[name="school_search"]').value = '';
        document.getElementById('district').value = 'all';
        document.getElementById('school').value = 'all';

        // Remove all query parameters and reload
        // This is the cleanest way for GET forms
        window.location.href = window.location.pathname;
    });
</script>
