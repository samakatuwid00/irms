...
<div class="p-6 space-y-6">
    ...
    <div class="bg-white shadow rounded-xl p-6">
        ...
        <form
            id="addNonPrintAcquisitionForm"
            action="{{ route('search-nonprint-resource.store', $resource->id) }}"
            method="POST"
            class="space-y-8"
        >
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                        <div>
                            ...
                            <p class="font-semibold text-gray-900">{{ $resource->nonprintTitle->title ?? 'N/A' }}</p>
                        </div>
                        <div>
            ...
            <div class="flex items-center justify-between pt-2">
                ...
                <button type="submit" id="npSaveBtn"
                    ...
                    <span id="npSaveBtnText">Save Acquisition(s)</span>
                    <span id="npSaveBtnLoading" class="hidden">
...
(function () {
    ...
    tableBody.addEventListener('click', e => {
        ...
        if (btn.dataset.action === 'delete') deleteAcq(idx);
    });
