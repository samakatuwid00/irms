    ...
    <div class="tab-content-wrapper">
        ...
        <div id="school-tab" class="tab-content hidden">
            <form method="GET" class="space-y-4 bg-white rounded-b-xl shadow p-4 mb-4">
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button"
                            class="reset-school bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg px-4 py-2">
                        Reset
                    </button>
                </div>
