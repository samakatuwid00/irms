<div x-data="{ activeTab: 'school' }" class="space-y-4">
    ...
    <div x-show="activeTab === 'school'" x-cloak>
        <div class="bg-white rounded-xl shadow p-4">
            <form method="GET" class="flex items-center gap-3">
                ...
                <button
                    type="button"
                    onclick="window.location.href='{{ route('print-resources') }}'"
            ...
            <form method="GET" class="flex items-center gap-3">
                ...
                <div class="relative w-full">
                    <input
                        ...
                        placeholder="Search Division Resources by Title, Author, ISBN, Publisher..."
                ...
                <button
                    type="button"
                    onclick="window.location.href='{{ route('print-resources') }}?tab=division'"
                    class="h-10 px-4 bg-gray-200 hover:bg-gray-300 text-sm text-gray-800 rounded-lg"
                >
                    Reset
                </button>
