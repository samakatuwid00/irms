...
(function () {
    ...
    /* ================================================================
       LIBRARY HELPERS  (works for both <select> and <input type="hidden">)
    ================================================================ */
    ...
    function handleAdd() {
        ...
        if (editIndex !== null) {
            // Preserve the original DB id so the service can upsert correctly
    ...
    /* ================================================================
       EVENT DELEGATION  (edit / delete buttons in table rows)
    ================================================================ */
