            ...
            >
                ...
                <div>
                    ...
                    <select name="usertype_subsub"
                        ...
                        @foreach (\App\Models\UserType::where('level', 1)->get() as $type)
                            <option value="{{ $type->id }}" {{ request('usertype_subsub') == $type->id ? 'selected' : '' }}>
                                {{ $type->type_name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="status_subsub"
                        ...
                        hx-push-url="true">
                        <option value="">All</option>
                        <option value="active" {{ request('status_subsub') === 'active' ? 'selected' : '' }}>Active</option>
                        <option value="pending" {{ request('status_subsub') === 'pending' ? 'selected' : '' }}>Pending</option>
                        <option value="deactivated" {{ request('status_subsub') === 'deactivated' ? 'selected' : '' }}>Deactivated</option>
                    </select>
                </div>
                <div class="md:col-span-4 flex justify-end gap-2">
