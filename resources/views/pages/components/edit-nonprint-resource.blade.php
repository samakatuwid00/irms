        ...
        <div class="md:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" value="{{ $nonprintResource->url }}" name="url" placeholder="https://example.com" class="w-full border rounded px-3 py-2">
                </div>
...
@php
    ...
    if ($nonprintResource && $nonprintResource->nonprintAcquisitions) {
...
<script>
    window.__nonprintResourceData = {
        acquisitions: @json($nonprintAcquisitionsData),
    };
</script>
