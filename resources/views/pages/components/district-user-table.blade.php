        ...
        <div class="overflow-x-auto bg-white rounded-xl shadow">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-4 py-3 text-center text-gray-500">No district users found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="overflow-x-auto bg-white rounded-xl shadow">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-4 py-3 text-center text-gray-500">No school users found under this district.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
