...
<div class="flex flex-col gap-4 mt-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
        <div class="flex items-center gap-2 text-sm text-gray-600">
            ...
            <select class="per-page-select border border-gray-300 rounded-xl px-3 py-1.5 text-sm bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
        ...
        <div class="flex items-center justify-center rounded-xl bg-gray-100 p-1">
            <button type="button"
                    class="view-toggle-btn flex items-center gap-1.5 rounded-lg px-4 py-2 text-sm font-medium transition-all {{ $cardActive ? 'bg-white text-blue-600 shadow' : 'text-gray-500 hover:text-gray-700' }}"
            ...
            <button type="button"
                    class="view-toggle-btn flex items-center gap-1.5 rounded-lg px-4 py-2 text-sm font-medium transition-all {{ $tableActive ? 'bg-white text-blue-600 shadow' : 'text-gray-500 hover:text-gray-700' }}"
