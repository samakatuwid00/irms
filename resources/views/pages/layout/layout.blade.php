                ...
                <ul class="space-y-1">
                    ...
                    @if (Auth::check() && in_array(Auth::user()?->userType?->level, [1, 3]))
                        <li>
                            <a href="{{ route('add-resources') }}"
                               class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-lg transition-colors
                                      {{ request()->routeIs('add-resources') ? 'bg-blue-100 text-blue-600' : 'text-gray-700 hover:bg-gray-100' }}">
                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <li>
                        <button type="button" id="mobile-resources-toggle"
                            ...
                            <svg id="mobile-resources-chevron" class="w-4 h-4 transition-transform {{ request()->routeIs('print-resources', 'nonprint-resources') ? 'rotate-180' : '' }}"
                                 xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path d="m6 9 6 6 6-6"/>
                            </svg>
                        </button>

                        <ul id="mobile-resources-submenu" class="mt-1 ml-8 space-y-1 {{ request()->routeIs('print-resources', 'nonprint-resources') ? '' : 'hidden' }}">
                            <li>
