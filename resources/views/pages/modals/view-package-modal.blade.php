...
<div id="viewNonPrintPackageModal" class="fixed inset-0 bg-black/50 z-100 hidden flex items-center justify-center p-4">
        ...
        <div class="p-6 space-y-8">
                ...
                <div class="md:col-span-2 space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p id="url" class="text-gray-900 mt-1 break-all"></p>
                        </div>
                        <div>
            ...
            <div class="border-t border-gray-300 pt-6">
                ...
                <div class="overflow-x-auto border border-gray-300 rounded-lg">
                    <table class="w-full text-sm" id="nonprintAcquisitionTable" data-user-level="{{ $level }}">
                        <thead class="bg-gray-100">
                            <tr>
                                @if($level == 4)
                                    <th class="border-b border-gray-300 px-1.5 py-0.5 text-left">Division</th>
                                @endif
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-left">Station</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-left">Source</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-left">Date Acquired</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-left">Cost</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-left">IAR No.</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-left">Remarks</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-center">Usable</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-center">PD</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-center">Damaged</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-center">Lost</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-center">Cond.</th>
                                <th class="border-b border-gray-300 px-1.5 py-0.5 text-center">Total</th>
                            </tr>
                        </thead>
